...
public class EnterCategoryTitleView extends android.support.v7.widget.AppCompatEditText {
    Drawable mClearButtonImage;



    public EnterCategoryTitleView(Context context) {
        super(context);
        init();
    }

    public EnterCategoryTitleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EnterCategoryTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                if ((getCompoundDrawablesRelative()[2] != null)) {
                    ...
                    if (isClearButtonClicked) {
                        ...
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            mClearButtonImage =
                                    ResourcesCompat.getDrawable(getResources(),
                                            R.drawable.icon_delete_x_translucent, null);
                            showClearButton();
                        }
                        // Check for ACTION_UP.
